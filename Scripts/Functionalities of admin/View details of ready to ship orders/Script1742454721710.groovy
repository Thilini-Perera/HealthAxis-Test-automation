...
WebUI.verifyElementPresent(findTestObject('Page_OrderDetails/lbl_OrderID'), 10)
WebUI.verifyElementPresent(findTestObject('Page_OrderDetails/lbl_OrderStatus'), 10)
WebUI.verifyElementText(findTestObject('Page_OrderDetails/lbl_OrderStatus'), 'Ready to Ship')
