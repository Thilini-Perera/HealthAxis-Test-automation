...
// Step 3: Click on 'Users' menu item in the sidebar
WebUI.click(findTestObject('Page_AdminDashboard/menu_Users'))

// Step 4: Verify the list of registered users is visible
WebUI.verifyElementPresent(findTestObject('Page_Users/tbl_RegisteredUsers'), 10)

// Step 5: Click 'Show Details' button in user card
WebUI.click(findTestObject('Page_Users/btn_ShowDetails_User1'))

// Step 6: Verify that user details are displayed
