...
WebUI.click(findTestObject('Page_AdminDashboard/menu_PendingOrders'))

// Step 4: Click on 'View Details' of a Pending Order
WebUI.click(findTestObject('Page_PendingOrders/btn_ViewDetails'))

// Step 5: Click on 'Process Order' Button
WebUI.click(findTestObject('Page_OrderDetails/btn_ProcessOrder'))

// Step 6: Verify Alert Message and Order Removal
WebUI.verifyTextPresent('Order is processed successfully', false)
WebUI.verifyElementNotPresent(findTestObject('Page_PendingOrders/order_ProcessedOrder'), 10)
