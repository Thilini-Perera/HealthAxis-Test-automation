...
// Step 5: Verify Order Details are Displayed with 'Process Order' Button
WebUI.verifyElementPresent(findTestObject('Page_OrderDetails/txt_OrderDetails'), 10)
WebUI.verifyElementPresent(findTestObject('Page_OrderDetails/btn_ProcessOrder'), 10)
